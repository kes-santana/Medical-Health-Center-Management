...
class SetNewDontUseWithEndpoint:
    ...
    def excecute(self,resource_id: int, restricted_resource_id: int) -> None:
        ...
        if restricted_resource_id in resource_id.dont_use_with:
        ...
        print(f"Ahora es necesario que el recurso {resource_id.name} no se use junto al recurso de ID: {restricted_resource_id}")

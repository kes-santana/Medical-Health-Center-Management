...
class CreateEventEndpoint:
    ...
    def create_event(self, date: str, time:str, owns_name: str, employee_id: int,
                     is_urgency: bool, necesary_resources: list[str], asigned_date_time_auto: bool,
                     appointment_name: str) -> str:
       
        comand = CreateEventCommand(date, time, owns_name, employee_id, is_urgency, necesary_resources,
